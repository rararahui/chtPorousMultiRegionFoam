...
#include "turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal.H"
...
turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal::
turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal
(
    const fvPatch& p,
...
:
    mixedFvPatchScalarField(p, iF),
    //pressureCoupledBase(patch(), dict),
...
turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal
(
    const turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal
(
    const turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal& wtcsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
    mixedFvPatchScalarField(wtcsf, iF),
    //pressureCoupledBase(patch(), wtcsf),
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    //typedef turbulentPressureCoupledBaffleMixedFvPatchScalarField thisType;
    typedef calculatedFvPatchField<scalar> thisType;
...
*/
    ...
    this->refGrad() = 0.0;
    this->valueFraction() = 1;//nbrKDelta()/(nbrKDelta() + myKDelta());
...
void turbulentPressureCoupledBaffleMixedFvPatchScalarFieldOnly1Cal::write
(
    Ostream& os
) const
{
