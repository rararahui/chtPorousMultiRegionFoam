...
turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField::
turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField
(
    const fvPatch& p,
...
turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField
(
    const turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField
(
    const turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField& wtcsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    tmp<scalarField> nbrKDelta = solidKappa_*nbrPatch.deltaCoeffs();
...
void turbulentFluidKappaOneCoupledBaffleMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
